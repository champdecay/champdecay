    ...
    return (
        <footer className="flex items-center h-96">
            <div className="mx-4 max-w-1/2 mx-auto sm:w-full sm:px-4 sm:text-center">
                <h2 className="my-4 text-xl sm:text-3xl"><a href="mailto:champdecay@gmail.com"><Highlight>champdecay@gmail.com</Highlight></a></h2>
                ...
                <ul className="flex items-center my-4 sm:justify-center">
                    ...
                    {/* https://www.instagram.com/champdecay/ */}
                    <li><a href="https://github.com/champdecay" className="p-2 block mr-4"><svg className="fill-blue-900" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 496 512" stroke="#000">
