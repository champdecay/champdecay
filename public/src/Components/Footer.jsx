        ...
        <footer className="flex items-center h-96">
            <div className="mx-4 max-w-1/2 mx-auto sm:w-full sm:px-4 sm:text-center">
                ...
                <ul className="flex items-center my-4 sm:justify-center">
                    ...
                    <li><a href="https://twitter.com/champdecay" className="p-2 block mr-4"><svg className="fill-blue-900" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke="#000">
