...
export default function Header() {
    return <header className="text-gray-600 body-font fixed w-full top-0 left-0 z-10 backdrop-blur-md bg-white/30">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <a href={Resume} target="_blank" className="inline-flex items-center bg-indigo-500 border-0 py-2 px-4 focus:outline-none rounded text-white mt-4 md:mt-0" style={{ backgroundImage: "linear-gradient(to right top, #051937, #004d7a, #008793, #00bf72, #a8eb12)" }}>Resume &nbsp;
